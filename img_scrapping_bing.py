...
class ImageFetcher(QWidget):
    ...
    def init_ui(self):
        ...
        self.progress_bar.setMaximum(100)  # Inicialmente definido como 100%
    ...
    def update_progress(self, current, total):
        ...
        QCoreApplication.processEvents()  # Força a atualização da interface gráfica
    ...
    def fetch_images_from_bing(self, query, folder, num_imgs, current_count):
        ...
        for link in img_links:
            ...
            if self.stop_process:
                break  # Parar o processo se o botão "Stop" foi pressionado

            # Vamos tentar baixar a imagem várias vezes antes de desistir
            for _ in range(2):  # tentar 2 vezes
                try:
    ...
    def fetch_images(self):
        self.stop_process = False  # Resetar a flag de parar o processo
